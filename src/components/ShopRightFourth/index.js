        ...
        <div className="selectFourth">
          ...
          <div className="buttonPadding">
            ...
            <div className="vhsxmPadding">
              <p className="vhsxm">
                완전 자율 주행 기능은 차량 인도 후에도 구입할 수 있으며, 새로운
                기능이 출시됨에 따라 추후에 가격이 인상될 수 있습니다.
              </p>
              <p className="vhsxm2">
                현재 활성화된 오토파일럿 기능은 운전자의 적극적인 제어가
                필요하며 완전 자율 주행이 가능한 것은 아닙니다. 이 기능을
                활성화하고 실제로 사용하기까지 수십억 마일의 주행 테스트를 통해
                차량의 자율 주행 능력이 운전자의 주행 능력보다 크게 앞선다는
                신뢰성과 규제 기관의 승인에 달려 있으며 일부 관할권에서는 규제
                승인이 더 오래 걸릴 수 있습니다. 자율 주행 기능이 진화함에 따라
                차량도 무선 소프트웨어(Over-The-Air)를 통해 지속적으로
                업그레이드 됩니다.
              </p>
            </div>
          </div>
